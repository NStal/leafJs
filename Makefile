.SUFFIXES: .coffee .js
COFFEE = coffee -c
FRONTCOFFEE = base.coffee eventEmitter.coffee util.coffee keyEventManager.coffee model.coffee collection.coffee namespace.coffee widget.coffee widgetEnhancement.coffee templateManager.coffee restApiFactory.coffee #apiManager.coffee apiFactory.coffee router.coffee
