...
(function() {
  var Collection, EventEmitter, Key, KeyEventManager, Leaf, List, Model, Mouse, Namespace, RestApiFactory, TemplateManager, Util, Widget, WidgetBase, exports,
    __slice = [].slice,
  ...
  Widget = (function(_super) {
    ...
    Widget.prototype.remove = function() {
      if (this.node.parentElement) {
        return node.parentElement.removeChild(this.node);
      }
    };
