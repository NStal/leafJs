...
(function() {
  var Collection, EventEmitter, Key, KeyEventManager, Leaf, List, Model, Mouse, Namespace, RestApiFactory, TemplateManager, Util, Widget, exports,
    __slice = [].slice,
  ...
  Namespace = (function(_super) {
    ...
    Namespace.prototype.applyTo = function(element) {
      var elem, elems, _i, _len;
      if (!this.selectorCache) {
        this.selectorCache = this.widget.map(function(item) {
          return Util.slugToCamel(item.scopeName);
        }).join(",");
      }
      elems = element.querySelectorAll(this.selectorCache);
