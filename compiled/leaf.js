...
(function() {
  var Collection, ErrorDoc, Errors, EventEmitter, Key, KeyEventManager, Leaf, List, Model, Mouse, Namespace, RestApiFactory, States, TemplateManager, Util, Widget, WidgetBase, exports, index, _i,
    __slice = [].slice,
  ...
  Namespace = (function(_super) {
    ...
    Namespace.prototype.createWidgetByElement = function(elem, name) {
      var Constructor, attr, param, widget, _j, _k, _len, _len1, _ref, _ref1;
  ...
  Widget = (function(_super) {
    ...
    Widget.prototype.initSubTemplate = function() {
      var name, template, templateNodes, tmpl, _j, _len, _results;
      this.templates = this.templates || {};
      templateNodes = this.node.querySelectorAll("template");
      templateNodes = [].slice.call(templateNodes, 0);
      _results = [];
      for (_j = 0, _len = templateNodes.length; _j < _len; _j++) {
        tmpl = templateNodes[_j];
    ...
    Widget.prototype.initSubWidgets = function() {
      var elem, elems, selector, _j, _len, _results;
      if (this.namespace) {
    ...
    Widget.prototype.initSubWidget = function(elem) {
      var attr, item, name, widget, _j, _k, _len, _len1, _ref, _ref1;
      if (!elem) {
        return;
      }
    ...
    Widget.prototype.initUI = function() {
      var elems, id, node, subNode, _j, _len;
      node = this.node;
    ...
    Widget.prototype.initDelegates = function() {
      var event, events, _j, _len, _results;
    ...
    Widget.prototype._delegateUnBubbleEvent = function(name) {
      var delegates, event, node, option, _j, _len, _ref, _results;
      if (this.disableDelegates) {
        return;
      }
      if (!name) {
      ...
      _results = [];
      for (_j = 0, _len = delegates.length; _j < _len; _j++) {
        option = delegates[_j];
  ...
  Widget = (function(_super) {
    ...
    Widget.prototype.initViewModel = function() {
      var attrs, elem, elems, selector, _j, _len, _results;
      attrs = Widget.attrs;
    ...
    Widget.prototype.applyRenderRole = function(elem) {
      var attr, attrs, info, _j, _len, _results;
      attrs = Widget.attrs;
      _results = [];
      for (_j = 0, _len = attrs.length; _j < _len; _j++) {
        attr = attrs[_j];
    ...
    Widget.prototype._classRole = function(elem, whos) {
      ...
      _results = [];
      for (_j = 0, _len = whos.length; _j < _len; _j++) {
        who = whos[_j];
        _results.push((function(_this) {
          return function(who) {
    ...
    Widget.prototype._attributeRole = function(elem, whats) {
      ...
      _results = [];
      for (_j = 0, _len = whats.length; _j < _len; _j++) {
        pair = whats[_j];
        _results.push((function(_this) {
  ...
  List = (function(_super) {
    ...
    function List(template, create) {
      ...
      Object.defineProperty(this, "length", {
        ...
        set: (function(_this) {
          return function(value) {
            var item, toRemove, _j, _k, _len, _ref, _results;
            toRemove = [];
            ...
            for (index = _j = value, _ref = _this.length; value <= _ref ? _j < _ref : _j > _ref; index = value <= _ref ? ++_j : --_j) {
              toRemove.push(_this[index]);
              delete _this[index];
            }
            _this._length = value;
            _results = [];
            for (_k = 0, _len = toRemove.length; _k < _len; _k++) {
              item = toRemove[_k];
    ...
    List.prototype.indexOf = function(item) {
      var child, _j, _len;
      for (index = _j = 0, _len = this.length; _j < _len; index = ++_j) {
        child = this[index];
        if (item === child) {
          return index;
        }
    ...
    List.prototype.push = function() {
      var item, items, _j, _len, _results;
    ...
    List.prototype.unshift = function(item) {
      ...
      for (index = _j = _ref = this._length; _ref <= 1 ? _j <= 1 : _j >= 1; index = _ref <= 1 ? ++_j : --_j) {
    ...
    List.prototype.shift = function() {
      var result, _j, _ref;
      result = this[0];
      for (index = _j = 0, _ref = this._length - 1; 0 <= _ref ? _j < _ref : _j > _ref; index = 0 <= _ref ? ++_j : --_j) {
        this[index] = this[index + 1];
      }
      this._length -= 1;
      this._detach(result);
    ...
    List.prototype.splice = function() {
      var count, frag, increase, index, item, offset, origin, result, toAdd, toAddFinal, toRemoves, _j, _k, _l, _len, _len1, _len2, _len3, _m, _n, _o, _p, _ref, _ref1, _ref2, _ref3;
      ...
      for (offset = _j = 0; 0 <= count ? _j < count : _j > count; offset = 0 <= count ? ++_j : --_j) {
      ...
      for (_k = 0, _len = toAddFinal.length; _k < _len; _k++) {
        item = toAddFinal[_k];
        this.check(item);
      ...
      for (offset = _n = 0, _len1 = toAddFinal.length; _n < _len1; offset = ++_n) {
        item = toAddFinal[offset];
        this[index + offset] = item;
      }
      this._length += increase;
      for (_o = 0, _len2 = toRemoves.length; _o < _len2; _o++) {
        item = toRemoves[_o];
        this._detach(item);
      }
      for (_p = 0, _len3 = toAddFinal.length; _p < _len3; _p++) {
        item = toAddFinal[_p];
        this._attach(item);
      }
      return result;
  ...
  TemplateManager = (function(_super) {
    ...
    TemplateManager.prototype._start = function() {
      var all, caches, remain, remainTemplates, tid, _j, _k, _l, _len, _len1, _len2, _ref, _ref1;
      if (this.enableCache) {
      ...
      for (_l = 0, _len2 = remain.length; _l < _len2; _l++) {
        tid = remain[_l];
    ...
    TemplateManager.prototype._extendNestedTemplates = function(templates) {
      var part, pathes, prop, result, root, value, _j, _len;
      result = {};
      for (prop in templates) {
        pathes = prop.split("/");
        result[prop] = templates[prop];
        root = result;
        for (index = _j = 0, _len = pathes.length; _j < _len; index = ++_j) {
          part = pathes[index];
    ...
    TemplateManager.prototype._fromDomForEach = function(tids) {
      var templateNode, templates, tid, _j, _len;
      templates = {};
      for (_j = 0, _len = tids.length; _j < _len; _j++) {
        tid = tids[_j];
  ...
  RestApiFactory = (function() {
    ...
    RestApiFactory.prototype.create = function(option) {
      var fn, method, reg, routeParams, _url;
      if (option == null) {
        option = {};
      }
    ...
    RestApiFactory.prototype.request = function(option, callback) {
      var done, method, timer, url, xhr, _callback;
      if (option == null) {
        option = {};
      }
    ...
    RestApiFactory.prototype.querify = function(data) {
      var base, encode, isolate, item, keys, querys, results, value, _j, _len;
      encode = encodeURIComponent;
      isolate = function(data) {
        var item, part, prop, result, _j, _k, _len, _len1;
        ...
        for (prop in data) {
          ...
          for (_k = 0, _len1 = part.length; _k < _len1; _k++) {
            item = part[_k];
