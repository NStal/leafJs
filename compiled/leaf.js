...
(function() {
  var Collection, EventEmitter, Key, KeyEventManager, Leaf, List, Model, Mouse, Util, Widget, exports,
    __slice = [].slice,
  ...
  Model = (function(_super) {
    ...
    Model.prototype.declare = function(name) {
      ...
      if (typeof this[name] === "undefined") {
        ...
        return console.warn("Model property name '" + name + "' conflict with an existing property of this model instance, and won't be overwritten. You can access it safely via Model.data." + name + " instead of model." + name);
      }
    };
    ...
    Model.prototype.ref = function(key) {
      if (!this._defines[key]) {
        throw new Error("undefined model property " + key);
      }
  ...
  Widget = (function(_super) {
    ...
    Widget.attrs = ["text", "html", "class", "value", "attribute"];
