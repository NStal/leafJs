...
(function() {
  var Collection, EnhancedWidget, EventEmitter, Key, KeyEventManager, Leaf, List, Model, Mouse, Router, Util, Widget, exports,
    __slice = [].slice,
  ...
  KeyEventManager = (function(_super) {
    ...
    KeyEventManager.prototype.unmaster = function() {
      ...
      return KeyEventManager.instances = [];
    };
  ...
  Model = (function(_super) {
    ...
    Model.prototype.declare = function(name) {
      ...
      this.data.__defineGetter__(name, (function(_this) {
        return function() {
          return obj.value;
        };
      })(this));
      return this.data.__defineSetter__(name, (function(_this) {
    ...
    Model.prototype.sets = function(obj) {
      ...
      _results = [];
      for (prop in obj) {
        if (this._defines[prop]) {
          _results.push(this.set(prop, obj[prop]));
        } else {
    ...
    Model.prototype.destroy = function() {
      ...
      this.isDestroy = true;
      console.debug(this._events["destroy"]);
      this.emit("destroy");
  ...
  Collection = (function(_super) {
    ...
    Collection.prototype.get = function(model) {
      ...
      this.models.some((function(_this) {
        return function(old) {
          if (_this.id) {
            if (old.get(_this.id) === model.get(_this.id)) {
              target = old;
              return true;
            }
            return false;
  ...
  EnhancedWidget = (function(_super) {
    __extends(EnhancedWidget, _super);

    EnhancedWidget.attrs = ["text", "html", "class", "value", "attribute"];

    function EnhancedWidget(template) {
      EnhancedWidget.__super__.constructor.call(this, template);
    ...
    EnhancedWidget.prototype.initTemplate = function(template) {
      var oldModel;
      oldModel = this.renderDataModel;
      this.renderDataModel = new Model();
      this.renderData = this.renderDataModel.data;
      EnhancedWidget.__super__.initTemplate.call(this, template);
      this.initRenderData();
      if (oldModel) {
    ...
    EnhancedWidget.prototype.initRenderData = function() {
    ...
    EnhancedWidget.prototype.applyRenderRole = function(elem) {
    ...
    EnhancedWidget.prototype.removeRenderRole = function(elem) {
      return this.renderDataModel.stopListenBy(elem);
    };

    EnhancedWidget.prototype._textRole = function(elem, who) {
    ...
    EnhancedWidget.prototype._htmlRole = function(elem, who) {
      if (!this.renderDataModel.has(who)) {
        this.renderDataModel.declare(who);
      }
      return this.renderDataModel.listenBy(elem, "change/" + who, (function(_this) {
    ...
    EnhancedWidget.prototype._classRole = function(elem, whos) {
    ...
    EnhancedWidget.prototype._attributeRole = function(elem, whats) {
    ...
    EnhancedWidget.prototype._valueRole = function(elem, who) {
      return this._attributeRole(elem, "value:" + who);
    };

    EnhancedWidget.prototype._srcRole = function(elem, who) {
      return this._attributeRole(elem, "src:" + who);
    };

    EnhancedWidget.prototype.destroy = function() {
      this.renderDataModel.destroy();
      this.renderDataModel = null;
      this.renderData = null;
      return EnhancedWidget.__super__.destroy.call(this);
    };
