...
(function() {
  var Collection, ErrorDoc, EventEmitter, Key, KeyEventManager, Leaf, List, Model, Mouse, Namespace, RestApiFactory, States, TemplateManager, Util, Widget, WidgetBase, exports,
    __slice = [].slice,
  ...
  States = (function(_super) {
    ...
    States.Errors = Leaf.ErrorDoc.create().define("InvalidState").define("AlreadyDestroyed").generate();
    ...
    States.prototype.setState = function(state) {
      ...
      if (this.isDestroyed) {
        this.emit("exception", new Errors.AlreadyDestroyed());
        return;
      }
      this.state = state;
    ...
    States.prototype.recover = function() {
      this.panicError = null;
      this.panicState = null;
      return this.setState("void");
    };
